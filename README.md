...
**NB** :
  ...
  information : `logging.level.io.github.fbibonne.springaddons.boot = INFO`
...
```text
2026-03-25T12:01:00.858+02:00  INFO 42091 --- [           main] io.github.fbibonne.springaddons.boot.propertieslogger.EnvironmentPreparedEventForPropertiesLogging           : 
================================================================================
...
lists the sources from which properties keys are collected: only the property sources
...
But the environment variable `SPRING_DATASOURCE_USERNAME` is also defined with the value
`user_prod`.
...
>
> 2. at second line, for the application.properties file,
...
since if the property is present in another source not excluded and if the value for
